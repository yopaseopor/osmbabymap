...
## Com us ajudo? Com ho faig servir?

### Veure

- Per veure elements tria primer la zona determinada (quant menys abarquis més ràpida serà la resposta). 
- Llavors un cop t'hi hagis apropat prou tries què vols trobar (es recomana no fer servir més d'una opció a la vegada). Exemple: https://yopaseopor.github.io/osmbabymap/#map=15.386/41.22192/1.72419/0&Playground%201|Parque|Parc=10000000000000000000000
- Si no ho trobes potser no n'hi ha o ens pots ajudar a completar la informació
...
- With the customization of [OSMPOIsMap](https://yopaseopor.github.io/osmpoismap) you will see the elements that interest you: changing rooms, lactation rooms, playgrounds as well as their conditions, other children stores, etc.
